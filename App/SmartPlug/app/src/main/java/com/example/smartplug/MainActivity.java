...
// Add the request to the RequestQueue.
        ...
        FloatingActionButton pair = findViewById(R.id.pair);
        pair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(toConnect!=null){
                    try {
                        BluetoothSocket conn = toConnect.createRfcommSocketToServiceRecord(UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"));
        ...
        final FloatingActionButton btbtn = findViewById(R.id.btbtn);
